...
export const About = () => {
  return (
    <div name='about' className='w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white'>
      <div className='p-2 mx-auto  flex flex-col justify-center w-full h-full md:max-w-screen-md lg:max-w-screen-lg sm:max-w-lg '>
        <div className='pb-4 sm:pb-1'>
          <p className='text-4xl sm:text-1xl font-bold inline border-b-4 border-gray-500'>About</p>
        </div>
